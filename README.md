...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.20787188.svg)](https://doi.org/10.5281/zenodo.20787188)
...
To fully replicate the analysis or run the scripts, users must combine the R code with the data cores hosted on [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.20788397.svg)](https://doi.org/10.5281/zenodo.20788397). 
</div>
